...
charecteristics='C:/Users/yschiff/OneDrive - Cisco/Desktop/Amnon/קובץ אפיונים.xlsx'
limitationsFile='C:/Users/yschiff/OneDrive - Cisco/Desktop/Amnon/קובץ אילוצים.xlsx'
semester1moed1tableFile='C:/Users/yschiff/OneDrive - Cisco/Desktop/Amnon/exam_schedule_semester1_moed1.xlsx'
semester2moed1tableFile='C:/Users/yschiff/OneDrive - Cisco/Desktop/Amnon/exam_schedule_semester2_moed1.xlsx'
###########################################################################
### Initialazing Data
...
validate_dict = {}
for prog in courses_per_program_df.columns:
    courses = list(courses_per_program_df[prog].dropna().values.astype(int))
    validate_dict[prog] = courses
    
if validate_dict == exam_scheduler.courses_per_program_dict:
    print('All courses of each program been scehduled')
else:
    print('Problem')
